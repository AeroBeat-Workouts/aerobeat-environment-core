...
var error_code: String = AeroEnvironmentConstantsScript.ERROR_INVALID_REQUEST
var message: String = ""
...
func apply_dict(data: Dictionary):
	...
	error_code = String(data.get("error_code", AeroEnvironmentConstantsScript.ERROR_INVALID_REQUEST)).strip_edges().to_lower()
